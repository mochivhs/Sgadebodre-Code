...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Forever Engine", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Forever Engine", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Forever Engine";
		app.meta["name"] = "sgadebodre - Forever Engine";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "sgadebodre - Forever Engine",
			width: 1280,
			x: null,
			y: null,
		};
