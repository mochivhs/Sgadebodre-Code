...
class HXCPP_CLASS_ATTRIBUTES Main_obj : public  ::openfl::display::Sprite_obj
{
	...
	public:
		...
		static ::cpp::VirtualArray gameWeeks;
		static void main();
		...
		static  ::flixel::FlxState lastState;
		static void switchState( ::flixel::FlxState curState, ::flixel::FlxState target);
		static ::Dynamic switchState_dyn();

		static void updateFramerate(int newFramerate);
		static ::Dynamic updateFramerate_dyn();
