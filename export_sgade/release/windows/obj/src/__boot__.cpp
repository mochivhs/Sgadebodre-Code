...
#endif
#ifndef INCLUDED_meta_data_Section
#include <meta/data/Section.h>
#endif
...
#include <__ASSET__assets_fonts_splatter_otf.h>
#endif
...
::meta::KeyboardScheme_obj::__register();
::meta::Control_obj::__register();
::meta::Device_obj::__register();
...
::meta::state::menus::StoryMenuState_obj::__register();
::meta::state::charting::OriginalChartingState_obj::__register();
::meta::state::charting::ChartingState_obj::__register();
::meta::state::TitleState_obj::__register();
::meta::state::PlayState_obj::__register();
::meta::state::CustomTitlescreen_obj::__register();
::meta::data::font::AlphaCharacter_obj::__register();
::meta::data::Timings_obj::__register();
::meta::data::Section_obj::__register();
::meta::data::PlayerSettings_obj::__register();
::meta::data::Highscore_obj::__register();
::meta::data::Conductor_obj::__register();
::meta::InfoHud_obj::__register();
::openfl::text::TextField_obj::__register();
::meta::CoolUtil_obj::__register();
...
::gameObjects::userInterface::notes::Note_obj::__register();
...
::meta::subState::PauseSubState_obj::__register();
::meta::subState::OptionsSubstate_obj::__register();
::meta::subState::GameOverSubstate_obj::__register();
::meta::state::menus::OptionsMenuState_obj::__register();
::meta::state::menus::MainMenuState_obj::__register();
::meta::state::menus::SongMetadata_obj::__register();
::meta::state::menus::FreeplayState_obj::__register();
::meta::data::font::Alphabet_obj::__register();
::meta::data::dependency::FNFTransition_obj::__register();
::meta::data::dependency::Discord_obj::__register();
::meta::data::Song_obj::__register();
::meta::data::ChartLoader_obj::__register();
::meta::MusicBeatSubState_obj::__register();
::meta::MusicBeatState_obj::__register();
::meta::data::dependency::FNFUIState_obj::__register();
::meta::Controls_obj::__register();
...
::gameObjects::userInterface::notes::Strumline_obj::__register();
::gameObjects::userInterface::notes::UIStaticArrow_obj::__register();
::gameObjects::userInterface::notes::NoteSplash_obj::__register();
::gameObjects::userInterface::menu::Selector_obj::__register();
::gameObjects::userInterface::menu::MenuItem_obj::__register();
::gameObjects::userInterface::menu::MenuCharacter_obj::__register();
::gameObjects::userInterface::menu::Checkmark_obj::__register();
::gameObjects::userInterface::HealthIcon_obj::__register();
::gameObjects::userInterface::DialogueBox_obj::__register();
::gameObjects::userInterface::ClassHUD_obj::__register();
::gameObjects::background::BackgroundGirls_obj::__register();
::gameObjects::background::BackgroundDancer_obj::__register();
::gameObjects::Stage_obj::__register();
::gameObjects::Boyfriend_obj::__register();
::gameObjects::Character_obj::__register();
::meta::data::dependency::FNFSprite_obj::__register();
...
::__ASSET__OPENFL__assets_fonts_splatter_otf_obj::__register();
::__ASSET__OPENFL__assets_fonts_pixel_otf_obj::__register();
::__ASSET__assets_fonts_vcr_ttf_obj::__register();
::__ASSET__assets_fonts_splatter_otf_obj::__register();
...
::ForeverTools_obj::__register();
::ForeverAssets_obj::__register();
::Date_obj::__register();
...
::meta::KeyboardScheme_obj::__boot();
::meta::Control_obj::__boot();
::meta::Device_obj::__boot();
...
::gameObjects::userInterface::notes::Note_obj::__boot();
...
::meta::CoolUtil_obj::__boot();
::openfl::text::TextField_obj::__boot();
::meta::InfoHud_obj::__boot();
::meta::data::Conductor_obj::__boot();
::meta::data::Highscore_obj::__boot();
::meta::data::PlayerSettings_obj::__boot();
::meta::data::Section_obj::__boot();
::meta::data::Timings_obj::__boot();
::meta::data::font::AlphaCharacter_obj::__boot();
::meta::state::CustomTitlescreen_obj::__boot();
::meta::state::PlayState_obj::__boot();
::meta::state::TitleState_obj::__boot();
::meta::state::charting::ChartingState_obj::__boot();
::meta::state::charting::OriginalChartingState_obj::__boot();
::meta::state::menus::StoryMenuState_obj::__boot();
