...
HXDLIN( 174)			::String tex1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/sgadebodre_asset_mads",70,d1,34,d4)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 174)			tex = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(tex1,::sys::io::File_obj::getContent(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/sgadebodre_asset_mads",70,d1,34,d4)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 175)			this->set_frames(tex);
HXLINE( 176)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("idle",14,a7,b3,45),24,false,null(),null());
...
HXDLIN( 165)			::String tex1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/sgadebodre_assets",21,93,e3,7a)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 165)			tex = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(tex1,::sys::io::File_obj::getContent(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("characters/sgadebodre_assets",21,93,e3,7a)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 166)			this->set_frames(tex);
HXLINE( 167)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("idle",14,a7,b3,45),24,false,null(),null());
