...
HXLINE( 116)		::haxe::Log_obj::trace(HX_("start",62,74,0b,84),::hx::SourceInfo(HX_("source_sgade/gameObjects/userInterface/DialogueBox.hx",1e,51,4a,4c),116,HX_("gameObjects.userInterface.DialogueBox",c7,c4,3c,b3),HX_("new",60,d0,53,00)));
...
HXDLIN( 443)			_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("source_sgade/gameObjects/userInterface/DialogueBox.hx",1e,51,4a,4c),443,HX_("gameObjects.userInterface.DialogueBox",c7,c4,3c,b3),HX_("runEvent",cf,00,fa,7d)));
...
HXDLIN( 465)			_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("source_sgade/gameObjects/userInterface/DialogueBox.hx",1e,51,4a,4c),465,HX_("gameObjects.userInterface.DialogueBox",c7,c4,3c,b3),HX_("runEvent",cf,00,fa,7d)));
...
HXDLIN( 482)				_g = (_g + 1);
HXLINE( 484)				::haxe::Log_obj::trace(event,::hx::SourceInfo(HX_("source_sgade/gameObjects/userInterface/DialogueBox.hx",1e,51,4a,4c),484,HX_("gameObjects.userInterface.DialogueBox",c7,c4,3c,b3),HX_("updateEvents",02,f6,2d,96)));
