...
HXLINE(  30)		::haxe::Log_obj::trace(options,::hx::SourceInfo(HX_("source_sgade/gameObjects/userInterface/menu/Selector.hx",22,4c,4e,91),30,HX_("gameObjects.userInterface.menu.Selector",02,6e,4d,4d),HX_("new",60,d0,53,00)));
