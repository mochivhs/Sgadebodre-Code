...
static const int _hx_array_data_54cda4cb_17[] = {
...
HXLINE( 179)			::Array< int > quantArray = ::Array_obj< int >::fromData( _hx_array_data_54cda4cb_17,10);
HXLINE( 181)			Float beatTimeSeconds = (( (Float)(60) ) / ::meta::data::Conductor_obj::bpm);
HXLINE( 182)			Float beatTime = (beatTimeSeconds * ( (Float)(1000) ));
HXLINE( 184)			Float measureTime = (beatTime * ( (Float)(4) ));
HXLINE( 186)			Float smallestDeviation = (measureTime / ( (Float)(quantArray->__get((quantArray->length - 1))) ));
HXLINE( 188)			{
HXLINE( 188)				int _g = 0;
HXDLIN( 188)				int _g1 = quantArray->length;
HXDLIN( 188)				while((_g < _g1)){
HXLINE( 188)					_g = (_g + 1);
HXDLIN( 188)					int quant = (_g - 1);
HXLINE( 192)					Float quantTime = (measureTime / ( (Float)(quantArray->__get(quant)) ));
HXLINE( 193)					if ((::hx::Mod(((strumTime + ::Init_obj::trueSettings->get(HX_("Offset",b3,0b,d4,94))) + smallestDeviation),quantTime) < (smallestDeviation * ( (Float)(2) )))) {
HXLINE( 196)						newNote->noteQuant = quant;
...
HXDLIN( 207)			if (( (bool)(isSustainNote) )) {
HXLINE( 207)				_hx_tmp = ::hx::IsNotNull( prevNote );
            			}
            			else {
HXLINE( 207)				_hx_tmp = false;
            			}
HXDLIN( 207)			if (_hx_tmp) {
HXLINE( 208)				newNote->noteQuant = prevNote->noteQuant;
            			}
HXLINE( 210)			if (!(( (bool)(isSustainNote) ))) {
HXLINE( 213)				int newNoteSize;
HXDLIN( 213)				if ((assetModifier == HX_("pixel",86,c6,a3,c2))) {
HXLINE( 213)					newNoteSize = 17;
            				}
            				else {
HXLINE( 213)					newNoteSize = 157;
            				}
HXLINE( 214)				::String library = null();
HXDLIN( 214)				Dynamic( newNote->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + ::ForeverTools_obj::returnSkinAsset(HX_("NOTE_quants",7d,28,ad,77),assetModifier,( (::String)(::Init_obj::trueSettings->get(HX_("Note Skin",6b,8d,33,f0))) ),HX_("noteskins/notes",d6,76,75,6d),HX_("quant",83,7e,e7,5d),null())) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),true,newNoteSize,newNoteSize,null(),null())).StaticCast<  ::meta::data::dependency::FNFSprite >();
HXLINE( 218)				newNote->animation->add(HX_("leftScroll",74,93,75,76),::Array_obj< int >::__new(1)->init(0,(newNote->noteQuant * 4)),null(),null(),null(),null());
HXLINE( 220)				newNote->animation->add(HX_("downScroll",0f,ba,68,84),::Array_obj< int >::__new(1)->init(0,(1 + (newNote->noteQuant * 4))),null(),null(),null(),null());
HXLINE( 221)				newNote->animation->add(HX_("upScroll",c8,68,6b,d1),::Array_obj< int >::__new(1)->init(0,(2 + (newNote->noteQuant * 4))),null(),null(),null(),null());
HXLINE( 222)				newNote->animation->add(HX_("rightScroll",09,a5,e9,b0),::Array_obj< int >::__new(1)->init(0,(3 + (newNote->noteQuant * 4))),null(),null(),null(),null());
            			}
            			else {
HXLINE( 227)				::String library = null();
HXDLIN( 227)				::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + ::ForeverTools_obj::returnSkinAsset(HX_("HOLD_quants",d0,ea,b8,a1),assetModifier,( (::String)(::Init_obj::trueSettings->get(HX_("Note Skin",6b,8d,33,f0))) ),HX_("noteskins/notes",d6,76,75,6d),HX_("quant",83,7e,e7,5d),null())) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXLINE( 229)				int _hx_tmp1;
HXDLIN( 229)				if ((assetModifier == HX_("pixel",86,c6,a3,c2))) {
HXLINE( 229)					_hx_tmp1 = 17;
            				}
            				else {
HXLINE( 229)					_hx_tmp1 = 109;
            				}
HXDLIN( 229)				int _hx_tmp2;
HXDLIN( 229)				if ((assetModifier == HX_("pixel",86,c6,a3,c2))) {
HXLINE( 229)					_hx_tmp2 = 6;
            				}
            				else {
HXLINE( 229)					_hx_tmp2 = 52;
            				}
HXLINE( 227)				Dynamic( newNote->loadGraphic(_hx_tmp,true,_hx_tmp1,_hx_tmp2,null(),null())).StaticCast<  ::meta::data::dependency::FNFSprite >();
HXLINE( 230)				newNote->animation->add(HX_("hold",3f,c9,12,45),::Array_obj< int >::__new(1)->init(0,(newNote->noteQuant * 4)),null(),null(),null(),null());
HXLINE( 231)				newNote->animation->add(HX_("holdend",fc,4b,02,b8),::Array_obj< int >::__new(1)->init(0,(1 + (newNote->noteQuant * 4))),null(),null(),null(),null());
HXLINE( 232)				newNote->animation->add(HX_("rollhold",3c,b7,29,23),::Array_obj< int >::__new(1)->init(0,(2 + (newNote->noteQuant * 4))),null(),null(),null(),null());
HXLINE( 233)				newNote->animation->add(HX_("rollend",7e,a4,22,5d),::Array_obj< int >::__new(1)->init(0,(3 + (newNote->noteQuant * 4))),null(),null(),null(),null());
            			}
HXLINE( 236)			if ((assetModifier == HX_("pixel",86,c6,a3,c2))) {
HXLINE( 238)				newNote->set_antialiasing(false);
HXLINE( 239)				Float _hx_tmp = newNote->get_width();
HXDLIN( 239)				newNote->setGraphicSize(::Std_obj::_hx_int((_hx_tmp * ::meta::state::PlayState_obj::daPixelZoom)),null());
HXLINE( 240)				newNote->updateHitbox();
            			}
            			else {
HXLINE( 244)				newNote->setGraphicSize(::Std_obj::_hx_int((newNote->get_width() * ((Float)0.7))),null());
HXLINE( 245)				newNote->updateHitbox();
HXLINE( 246)				newNote->set_antialiasing(true);
            			}
            		}
HXLINE( 251)		if (!(( (bool)(isSustainNote) ))) {
HXLINE( 252)			 ::flixel::animation::FlxAnimationController newNote1 = newNote->animation;
HXDLIN( 252)			newNote1->play((::gameObjects::userInterface::notes::UIStaticArrow_obj::getArrowFromNumber(noteData) + HX_("Scroll",2d,4c,f9,7b)),null(),null(),null());
            		}
HXLINE( 256)		bool _hx_tmp1;
HXDLIN( 256)		if (( (bool)(isSustainNote) )) {
HXLINE( 256)			_hx_tmp1 = ::hx::IsNotNull( prevNote );
            		}
            		else {
HXLINE( 256)			_hx_tmp1 = false;
            		}
HXDLIN( 256)		if (_hx_tmp1) {
HXLINE( 258)			newNote->noteSpeed = prevNote->noteSpeed;
HXLINE( 259)			Float _hx_tmp;
HXDLIN( 259)			if (( (bool)(::Init_obj::trueSettings->get(HX_("Opaque Holds",d5,d1,24,ba))) )) {
HXLINE( 259)				_hx_tmp = ( (Float)(1) );
            			}
            			else {
HXLINE( 259)				_hx_tmp = ((Float)0.6);
            			}
HXDLIN( 259)			newNote->set_alpha(_hx_tmp);
HXLINE( 260)			newNote->animation->play(HX_("holdend",fc,4b,02,b8),null(),null(),null());
HXLINE( 261)			newNote->updateHitbox();
HXLINE( 263)			if (prevNote->isSustainNote) {
HXLINE( 265)				prevNote->animation->play(HX_("hold",3f,c9,12,45),null(),null(),null());
HXLINE( 267)				{
HXLINE( 267)					 ::flixel::math::FlxPoint _g = prevNote->scale;
HXDLIN( 267)					_g->set_y((_g->y * ((((::meta::data::Conductor_obj::stepCrochet / ( (Float)(100) )) * ((Float)0.82692307692307687)) * ((Float)1.5)) * prevNote->noteSpeed)));
            				}
HXLINE( 268)				prevNote->updateHitbox();
            			}
            		}
HXLINE( 273)		return newNote;
            	}
