...
HXLINE(  75)		::haxe::Log_obj::trace(libraryArray,::hx::SourceInfo(HX_("source_sgade/meta/CoolUtil.hx",0e,7d,fb,61),75,HX_("meta.CoolUtil",54,26,4a,95),HX_("returnAssetsLibrary",e8,e9,3c,33)));
