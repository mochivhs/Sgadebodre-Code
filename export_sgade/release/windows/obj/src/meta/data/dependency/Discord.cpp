...
HXDLIN(  42)		::haxe::Log_obj::trace((((HX_("Error! ",87,92,5b,b7) + _code) + HX_(" : ",c6,7a,18,00)) + _message),::hx::SourceInfo(HX_("source_sgade/meta/data/dependency/Discord.hx",36,23,94,d8),42,HX_("meta.data.dependency.Discord",04,c4,e2,c6),HX_("onError",29,6a,67,09)));
            	}
...
HXDLIN(  47)		::haxe::Log_obj::trace((((HX_("Disconnected! ",7a,e1,87,53) + _code) + HX_(" : ",c6,7a,18,00)) + _message),::hx::SourceInfo(HX_("source_sgade/meta/data/dependency/Discord.hx",36,23,94,d8),47,HX_("meta.data.dependency.Discord",04,c4,e2,c6),HX_("onDisconnected",7a,eb,5a,b8)));
            	}
