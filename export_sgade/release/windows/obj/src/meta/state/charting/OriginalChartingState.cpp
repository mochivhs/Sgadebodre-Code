...
HXLINE( 197)			::haxe::Log_obj::trace(HX_("CHECKED!",3a,9f,7d,06),::hx::SourceInfo(HX_("source_sgade/meta/state/charting/OriginalChartingState.hx",6a,65,5d,e2),197,HX_("meta.state.charting.OriginalChartingState",58,5e,b8,8e),HX_("addSongUI",6a,02,ad,e5)));
            		}
...
HXLINE( 514)			::haxe::Log_obj::trace(this->curStep,::hx::SourceInfo(HX_("source_sgade/meta/state/charting/OriginalChartingState.hx",6a,65,5d,e2),514,HX_("meta.state.charting.OriginalChartingState",58,5e,b8,8e),HX_("update",09,86,05,87)));
HXLINE( 515)			::haxe::Log_obj::trace((( (int)( ::Dynamic(this->_song->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__GetItem(this->curSection)->__Field(HX_("lengthInSteps",3c,ed,41,db),::hx::paccDynamic)) ) * (this->curSection + 1)),::hx::SourceInfo(HX_("source_sgade/meta/state/charting/OriginalChartingState.hx",6a,65,5d,e2),515,HX_("meta.state.charting.OriginalChartingState",58,5e,b8,8e),HX_("update",09,86,05,87)));
HXLINE( 516)			::haxe::Log_obj::trace(HX_("DUMBSHIT",e6,67,07,01),::hx::SourceInfo(HX_("source_sgade/meta/state/charting/OriginalChartingState.hx",6a,65,5d,e2),516,HX_("meta.state.charting.OriginalChartingState",58,5e,b8,8e),HX_("update",09,86,05,87)));
...
HXLINE( 543)							::haxe::Log_obj::trace(HX_("tryin to delete note...",0c,35,c3,ba),::hx::SourceInfo(HX_("source_sgade/meta/state/charting/OriginalChartingState.hx",6a,65,5d,e2),543,HX_("meta.state.charting.OriginalChartingState",58,5e,b8,8e),HX_("update",09,86,05,87)));
...
HXLINE( 764)		::haxe::Log_obj::trace((HX_("changing section",72,75,c1,9c) + sec),::hx::SourceInfo(HX_("source_sgade/meta/state/charting/OriginalChartingState.hx",6a,65,5d,e2),764,HX_("meta.state.charting.OriginalChartingState",58,5e,b8,8e),HX_("changeSection",55,aa,ac,be)));
...
HXLINE( 995)		::haxe::Log_obj::trace(noteStrum1,::hx::SourceInfo(HX_("source_sgade/meta/state/charting/OriginalChartingState.hx",6a,65,5d,e2),995,HX_("meta.state.charting.OriginalChartingState",58,5e,b8,8e),HX_("addNote",b3,5a,47,85)));
HXLINE( 996)		::haxe::Log_obj::trace(this->curSection,::hx::SourceInfo(HX_("source_sgade/meta/state/charting/OriginalChartingState.hx",6a,65,5d,e2),996,HX_("meta.state.charting.OriginalChartingState",58,5e,b8,8e),HX_("addNote",b3,5a,47,85)));
...
HXDLIN(1041)		::haxe::Log_obj::trace( ::Dynamic(this->_song->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic)),::hx::SourceInfo(HX_("source_sgade/meta/state/charting/OriginalChartingState.hx",6a,65,5d,e2),1041,HX_("meta.state.charting.OriginalChartingState",58,5e,b8,8e),HX_("loadLevel",7e,61,9a,8d)));
            	}
