...
HXLINE( 233)			::haxe::Log_obj::trace((HX_("CUR WEEK",b4,9a,a0,36) + ::meta::state::PlayState_obj::storyWeek),::hx::SourceInfo(HX_("source_sgade/meta/state/menus/FreeplayState.hx",0b,64,05,1a),233,HX_("meta.state.menus.FreeplayState",71,99,7d,7c),HX_("update",09,86,05,87)));
...
HXLINE( 316)		::haxe::Log_obj::trace((HX_("curSelected: ",61,53,7b,26) + this->curSelected),::hx::SourceInfo(HX_("source_sgade/meta/state/menus/FreeplayState.hx",0b,64,05,1a),316,HX_("meta.state.menus.FreeplayState",71,99,7d,7c),HX_("changeSelection",bc,98,b5,48)));
...
HXLINE( 332)						::haxe::Log_obj::trace(HX_("Killing thread",86,eb,4c,06),::hx::SourceInfo(HX_("source_sgade/meta/state/menus/FreeplayState.hx",0b,64,05,1a),332,HX_("meta.state.menus.FreeplayState",71,99,7d,7c),HX_("changeSongPlaying",89,04,7c,d1)));
HXLINE( 333)						return;
            					}
...
HXDLIN( 339)						if (h) {
HXLINE( 341)							::haxe::Log_obj::trace((HX_("Loading index ",12,ba,89,96) + index),::hx::SourceInfo(HX_("source_sgade/meta/state/menus/FreeplayState.hx",0b,64,05,1a),341,HX_("meta.state.menus.FreeplayState",71,99,7d,7c),HX_("changeSongPlaying",89,04,7c,d1)));
...
HXLINE( 358)								::haxe::Log_obj::trace((HX_("Nevermind, skipping ",5d,fb,31,6b) + index),::hx::SourceInfo(HX_("source_sgade/meta/state/menus/FreeplayState.hx",0b,64,05,1a),358,HX_("meta.state.menus.FreeplayState",71,99,7d,7c),HX_("changeSongPlaying",89,04,7c,d1)));
            							}
            						}
            						else {
HXLINE( 361)							::haxe::Log_obj::trace((HX_("Skipping ",6f,0e,3d,e5) + index),::hx::SourceInfo(HX_("source_sgade/meta/state/menus/FreeplayState.hx",0b,64,05,1a),361,HX_("meta.state.menus.FreeplayState",71,99,7d,7c),HX_("changeSongPlaying",89,04,7c,d1)));
            						}
            					}
            				}
            			}
