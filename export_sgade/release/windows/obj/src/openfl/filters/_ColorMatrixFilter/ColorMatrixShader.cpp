...
HXLINE( 279)		 ::Dynamic(this->get_data()->__Field(HX_("uMultipliers",5d,5b,61,e5),::hx::paccDynamic))->__SetField(HX_("value",71,7f,b8,31),::cpp::VirtualArray_obj::__new(16)->init(0,1)->init(1,0)->init(2,0)->init(3,0)->init(4,0)->init(5,1)->init(6,0)->init(7,0)->init(8,0)->init(9,0)->init(10,1)->init(11,0)->init(12,0)->init(13,0)->init(14,0)->init(15,1),::hx::paccDynamic);
HXLINE( 280)		 ::Dynamic(this->get_data()->__Field(HX_("uOffsets",8b,59,c4,c8),::hx::paccDynamic))->__SetField(HX_("value",71,7f,b8,31),::cpp::VirtualArray_obj::__new(4)->init(0,0)->init(1,0)->init(2,0)->init(3,0),::hx::paccDynamic);
...
HXLINE( 287)		::Array< Float > multipliers = ( (::Array< Float >)( ::Dynamic(this->get_data()->__Field(HX_("uMultipliers",5d,5b,61,e5),::hx::paccDynamic))->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic)) );
HXLINE( 288)		::Array< Float > offsets = ( (::Array< Float >)( ::Dynamic(this->get_data()->__Field(HX_("uOffsets",8b,59,c4,c8),::hx::paccDynamic))->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic)) );
