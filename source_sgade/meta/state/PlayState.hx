...
class PlayState extends MusicBeatState
{
	...
	override function beatHit()
	{
		...
		//haha copy and pasted code go brrRrRrrRrR
		if (curSong.toLowerCase() == 'bodre' && curBeat >= 48 && curBeat < 112 && FlxG.camera.zoom < 1)
			{
				FlxG.camera.zoom += 0.2;
				camHUD.zoom += 0.02;
			}
		if (curSong.toLowerCase() == 'bodre' && curBeat >= 112 && curBeat < 176 && FlxG.camera.zoom < 1.2)
			{
				FlxG.camera.zoom += 0.3;
				camHUD.zoom += 0.02;
			}
		if (curSong.toLowerCase() == 'bodre' && curBeat >= 176 && curBeat < 240 && FlxG.camera.zoom < 1)
			{
				FlxG.camera.zoom += 0.2;
				camHUD.zoom += 0.02;
			}
		if (curSong.toLowerCase() == 'bodre' && curBeat >= 240 && curBeat < 272 && FlxG.camera.zoom < 1.2)
			{
				FlxG.camera.zoom += 0.3;
				camHUD.zoom += 0.02;
			}	
		if (curSong.toLowerCase() == 'bodre' && curBeat >= 272 && curBeat < 304 && FlxG.camera.zoom < 1.8)
			{
				FlxG.camera.zoom += 0.6;
				camHUD.zoom += 0.02;
			}	
		if (curSong.toLowerCase() == 'erdobedags' && curBeat >= 64 && curBeat < 128 && FlxG.camera.zoom < 2)
			{
				FlxG.camera.zoom += 0.6;
				camHUD.zoom += 0.02;
			}	
		if (curSong.toLowerCase() == 'erdobedags' && curBeat >= 136 && curBeat < 296 && FlxG.camera.zoom < 2)
			{
				FlxG.camera.zoom += 0.6;
				camHUD.zoom += 0.02;
			}				
